...
@if ($paginator->hasPages())
   <nav class="flexbox mt-30">
       ...
       @else
        <a class="btn btn-white "><i class="ti-arrow-left fs-9 mr-4" href="{{$paginator->previousPageUrl()}}"></i>  Previous</a>
...
<a class="btn btn-white" href=" {{$paginator->nextPageUrl() }}">Next<i class="ti-arrow-right fs-9 ml-4"></i></a>
        ...
        @endif
                {{-- <i class="btn btn-white" href="#">Older <i class="ti-arrow-right fs-9 ml-4"></i></i> --}}
              </nav>
